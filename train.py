...
parser.add_argument('data_dir', default = 'flowers/train')
parser.add_argument('--save_dir', dest = 'checkpoint_dir', action = 'store', type = str, help = 'Would you like to save the checkpoint after training?')
